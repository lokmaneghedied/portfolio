    ...
    return ( 
        <section id="education" ref={ref} className="lg:h-[850px] w-full flex justify-start items-center relative mt-10 md:mt-0">
            ...
            <motion.div 
                ...
                className="absolute origin-top top-[60px] lg:top-[90px] left-[27px] lg:left-1/2 bg-accent w-[4px] h-[790px] xs:h-[600px] xxs:h-[500px] sm:h-[450px] md:h-[430px] lg:h-[620px]" />
