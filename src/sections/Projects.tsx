        ...
        <section id="projects" className="w-full flex flex-col items-center justify-center space-y-4 lg:space-y-0 pt-8 lg:grid lg:justify-items-center lg:content-center lg:grid-cols-2 gap-4 ">
            ...
            <motion.div
                ...
                className="w-[90%] sm:w-[70%] lg:w-[90%] h-1/5 lg:h-full group relative overflow-hidden border-2 border-white/50 rounded-xl">
                    ...
                    <img className="group-hover:scale-125 transition-all duration-500 h-full" src={healthy24} alt="HooBank" />
                        {/* links */}
            ...
            <motion.div 
                ...
                whileInView={'show'}
                viewport={{once : false, amount: 0.7}} 
                className="w-[90%] sm:w-[70%] lg:w-[95%] h-1/5 lg:h-[90%] lg:flex lg:justify-center lg:col-span-2 group relative overflow-hidden border-2 border-white/50 rounded-xl">
                <div className="group-hover:bg-black/50 w-full h-full absolute z-40 transition-all duration-500"></div>
                <img className="group-hover:scale-125 transition-all duration-500 h-full lg:hidden" src={gericht} alt="GERICHT" />
                <img className="group-hover:scale-125 transition-all duration-500 h-full hidden lg:block" src={gericht_wide} alt="GERICHT" />
                {/* links */}
                <span className="absolute -bottom-full z-40 left-5 group-hover:bottom-11 transition-all duration-500">
