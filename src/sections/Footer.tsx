            ...
            <div className="flex justify-between pt-2">
                ...
                <span className="flex justify-end items-center space-x-2 ">
                    <a href="https://www.linkedin.com/in/lokmane-ghedied/" target='_blank'>
                       <FaLinkedinIn className="w-4 h-4 lg:w-5 lg:h-5 hover:scale-125"/>
                    </a>
                    <a href="https://github.com/lokmaneghedied" target='_blank'>
                        <FaGithub  className="w-4 h-4 lg:w-5 lg:h-5 hover:scale-125"/>
                    </a>
                    <a href="https://wa.me/qr/OAEK2373L7XIH1" target='_blank'>
                        <AiOutlineWhatsApp  className="w-4 h-4 lg:w-5 lg:h-5 hover:scale-125"/>
                    </a>
                    <CiLocationOn onClick={openMaps} className="w-4 h-4 lg:w-5 lg:h-5 cursor-pointer hover:scale-125"/>
                    <AiOutlinePhone onClick={openPhone} className="w-4 h-4 lg:w-5 lg:h-5 cursor-pointer hover:scale-125"/>
                </span>
            </div>
        </section>
     );
