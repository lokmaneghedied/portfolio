...
const NavBar = () => {
    ...
    const toggle = "flex justify-between items-center bg-white h-20 w-full border-b border-red-500";
    ...
    return ( 
        <div className={toggleNavBar ? toggle : intoggle}>
                <button onClick={()=>setToggleNavBar(!toggleNavBar)} className="p-2 m-2 sm:bg-white sm:shadow-md rounded-lg">
