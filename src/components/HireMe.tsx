...
const HireMe = () => {
    ...
    return ( 
        <div className='flex justify-center items-center '>
            ...
            <button onClick={sendEmail} className='bg-accent text-white text-xs font-bold absolute rounded-full xs:h-[40px] xs:w-[40px] lg:h-[60px] lg:w-[60px] hover:scale-110'>Hire Me</button>
        </div>
     );
}
